      ...
      <div className={styles.regulationsSection}>
        <div className={styles.regulationsHeader}>
          ...
          <p className={styles.regulationsDesc}>
            Полное описание, математические формулы, коэффициенты, исключения и правила автоматического учета KPI для сотрудников и руководителей Agile Control Center.
          </p>
        </div>
